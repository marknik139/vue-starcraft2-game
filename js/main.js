let app = new Vue({
    ...
    methods: {
        ...
        endGame() {
            ...
            if (this.score.zerg > this.score.protoss && this.score.zerg > this.score.zerg > this.score.terran &&
...
//Music has been removed from the game due to google chrome policy
